...
import data from '../../constants/carousel-animation-list';
    ...
    <View style={styles.container}>
      ...
      <Animated.FlatList
        ...
        renderItem={({item, index}) =>
          // (
          //   <Item {...item} index={index} scrollX={scrollX} ref={ref}/>
          // )
          {
            const inputRange = [
              (index - 1) * width,
      ...
      {/* <Image
        style={styles.logo}
        source={require('../../assets/images/urbanears_blue.png')}
      /> */}
